...
public:
	...
	void setWeatherSystemDirect(ParticleSystem* system, const String& type);
	void forceWeatherUpdate();
	ParticleSystem* getWeatherSystem() { return mWeatherSystem; }
	void setWeatherSystem(ParticleSystem* system) { mWeatherSystem = system; }
	String getWeatherType() { return weatherType; }
	void setWeatherType(const String& type) { weatherType = type; }
};